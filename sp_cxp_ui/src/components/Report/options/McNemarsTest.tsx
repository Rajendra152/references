...
const McnemarsTest: React.FunctionComponent = ({ isOpen, close, OpenHelpWindow,
  helpMenu, modalData }) => {
  ...
  useEffect(() => {
    help("wbasics", "options_for_mcnemar_s", "");
    getOptionsData();
  }, []);
  ...
  return (
    <div>
      ...
      >
        ...
        {/* <div className="msid " dir="ltr">
                    <div className='ms-Grid-row' >
                        <div className={contentStyles.header}>
                            <div className="ms-Grid-col ms-sm9">                    <span id={'title1'}>
                                Options for McNemar's
                            </span>
                            </div>
        ...
        {/* <div className={contentStyles.body}>
                    {Object.keys(options).length && <Pivot aria-label="Report Options Configuration" className="FormatContainer">
                        <PivotItem headerText="Options"><br />
                            <Checkbox className={contentStyles.column} label="Yates Correction Factor" checked={options.CZTest[0].checked} onChange={(e) => udpateOptions('CZTest', e, 0)} />
                        </PivotItem>
                    </Pivot>}
                    <OptionsFooter
                        close={close}
