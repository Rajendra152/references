...
const setIdKey = "RMAnovaOnRanks";

const RMANOVAOnRanks: React.FunctionComponent = ({
  isOpen,
  close,
  OpenHelpWindow,
  helpMenu,
  ...
  useEffect(() => {
    help(
      "wbasics",
      "options_for_repeated_measures_anova_on_ranks__assumption_checking",
      ""
    );
    getOptionsData();
  }, []);
  const getSelectedItem = (
    ...
    if (item.props.headerText == "Assumption Checking") {
      ...
      help(
        "wbasics",
        "options_for_repeated_measures_anova_on_ranks__post_hoc_tests",
        ""
      );
    }
  };
