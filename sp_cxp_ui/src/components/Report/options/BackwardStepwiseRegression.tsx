...
const setIdKey = "backwardStepwiseRegression";

const BackwardStepwiseRegression: React.FunctionComponent = ({
  isOpen,
  close,
  OpenHelpWindow,
  helpMenu,
  ...
  useEffect(() => {
    help("wbasics", "options_for_backward_stepwise_regression__criterion", "");
    getOptionsData();
  }, []);
            ...
            <Pivot
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_backward_stepwise_regression__criterion",
                    ""
                  )
                }>
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_backward_stepwise_regression__assumption_checking",
                    ""
                  )
                }
                style={{ display: "flex" }}>
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_backward_stepwise_regression__residuals",
                    ""
                  )
                }>
                <br />
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_backward_stepwise_regression__more_statistics",
                    ""
                  )
                }>
                <br />
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_backward_stepwise_regression__other_diagnostics",
                    ""
                  )
                }
...
export default BackwardStepwiseRegression;
