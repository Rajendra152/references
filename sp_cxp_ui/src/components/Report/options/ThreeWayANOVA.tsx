...
const setIdKey = "threeWayAnova";

const ThreeWayANOVA: React.FunctionComponent = ({
  isOpen,
  close,
  OpenHelpWindow,
  helpMenu,
  ...
  useEffect(() => {
    help("wbasics", "options_for_three_way_anova__assumption_checking", "");
    getOptionsData();
  }, []);
  const getSelectedItem = (
    ...
    if (item.props.headerText == "Assumption Checking") {
      ...
      help("wbasics", "options_for_three_way_anova__results", "");
    } else if (item.props.headerText == "Post Hoc Tests") {
      help("wbasics", "options_for_three_way_anova__post_hoc_tests", "");
    }
  };
  return (
    <div>
            ...
            <Pivot
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_three_way_anova__assumption_checking",
                    ""
                  )
                }
                style={{ display: "flex" }}>
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_three_way_anova__post_hoc_tests",
                    ""
                  )
                }
                className={contentStyles.pocSection}>
