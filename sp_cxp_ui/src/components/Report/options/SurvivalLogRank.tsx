...
const setIdKey = "survivalLogRank";

const dropdownStyles: Partial<IDropdownStyles> = {
  dropdown: { width: 150 },
};

const SurvivalLogRank: React.FunctionComponent = ({
  isOpen,
  close,
  OpenHelpWindow,
  helpMenu,
  ...
  useEffect(() => {
    help("wbasics", "options_for_survival_logrank__graph_options", "");
    getOptionsData();
  }, []);
  const getSelectedItem = (
    ...
    if (item.props.headerText == "Graph Options") {
      ...
      help("wbasics", "options_for_survival_log_rank__results", "");
    } else if (item.props.headerText == "Post Hoc Tests") {
      help("wbasics", "options_for_survival_logrank__post_hoc_tests", "");
    }
  };
            ...
            <Pivot
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_survival_logrank__graph_options",
                    ""
                  )
                }>
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_survival_logrank__post_hoc_tests",
                    ""
                  )
                }>
                <div className='ms-Grid' dir='ltr'>
...
export default SurvivalLogRank;
