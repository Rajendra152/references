...
const setIdKey = "twoWayRMAnova";

const TwoWayRMANOVA: React.FunctionComponent = ({
  isOpen,
  close,
  updateRedis,
  OpenHelpWindow,
  ...
  const getSelectedItem = (
    ...
    if (item.props.headerText == "Assumption Checking") {
      help(
        "wbasics",
        "options_for_two_way_repeated_measures_anova__assumption_checking",
        ""
      );
    } else if (item.props.headerText == "Results") {
      help(
        "wbasics",
        "options_for_two_way_repeated_measures_anova__results",
        ""
      );
    } else if (item.props.headerText == "Post Hoc Tests") {
      help(
        "wbasics",
        "options_for_two_way_repeated_measures_anova__post_hoc_tests",
        ""
      );
    }
  };
