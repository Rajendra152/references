...
const setIdKey = "oneSampleTTest";

const OneSampleTTest: React.FunctionComponent = ({
  isOpen,
  close,
  OpenHelpWindow,
  helpMenu,
  ...
  useEffect(() => {
    help("wbasics", "options_for_one_sample_t_test__assumption_checking", "");
    getOptionsData();
  }, []);
  const getSelectedItem = (
    ...
    if (item.props.headerText == "Assumption Checking") {
      ...
      help("wbasics", "options_for_one_sample_t_test__results", "");
    } else if (item.props.headerText == "Post Hoc Tests") {
      help("wbasics", "options_for_one_sample_t_test__post_hoc_tests", "");
    }
  };
  return (
    <div>
      ...
      >
        v <div className={contentStyles.header} style={{ display: "flex", justifyContent: 'space-between' }}>
            ...
            <Pivot
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_one_sample_t_test__assumption_checking",
                    ""
                  )
                }
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_one_sample_t_test__post_hoc_tests",
                    ""
                  )
                }
                className={contentStyles.assumptionSection}>
