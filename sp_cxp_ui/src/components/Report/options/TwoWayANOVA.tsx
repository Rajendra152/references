...
const setIdKey = "twoWayAnova";

const TwoWayANOVA: React.FunctionComponent = ({
  isOpen,
  close,
  OpenHelpWindow,
  helpMenu,
  ...
  useEffect(() => {
    help("wbasics", "options_two_way_anova__assumption_checking", "");
    getOptionsData();
  }, []);
  const getSelectedItem = (
    ...
    if (item.props.headerText == "Assumption Checking") {
      ...
      help("wbasics", "options_two_way_anova__results", "");
            ...
            <Pivot
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_two_way_anova__assumption_checking",
                    ""
                  )
                }
                style={{ display: "flex" }}>
