...
const setIdKey = "coxPHModel";

const dropdownStyles: Partial<IDropdownStyles> = {
  dropdown: { width: 150 },
};

const CoxPHModel: React.FunctionComponent = ({
  isOpen,
  close,
  OpenHelpWindow,
  helpMenu,
  ...
  useEffect(() => {
    help("wbasics", "options_for_cox_regression_proportional_hazard__criterion", "");
