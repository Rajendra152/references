...
const tabKeys: string[] = ["CAssumeCheck", "CResultsPercentile"];
const dataKey = "signedRankedTest";

const SignedRankTest: React.FunctionComponent = ({
  isOpen,
  close,
  OpenHelpWindow,
  helpMenu,
  ...
  useEffect(() => {
    help("wbasics", "options_for_signed_rank_test__assumption_checking", "");
    getOptionsData();
  }, []);
  const getSelectedItem = (
    ...
    if (item.props.headerText == "Assumption Checking") {
      ...
      help("wbasics", "options_for_signed_rank_test__results", "");
            ...
            <Pivot
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_signed_rank_test__assumption_checking",
                    ""
                  )
                }
              ...
              <PivotItem
                ...
                <fieldset className={contentStyles.fieldSet}>
                  ...
                  <div className={contentStyles.columns}>
                    ...
                    <div style={{ flex: "0 0 20%" }}>
                      <TextField
                        disabled={!options.CResultsPercentile[0].checked}
                        name='StrFromPercent'
                ...
                <div
                  ...
                  <Checkbox
                    ...
                    checked={options.CResultsPercentile[3].checked}
                    onChange={(e) => udpateOptions("CResultsPercentile", e, 3)}
                  />
                </div>
              </PivotItem>
            </Pivot>
