...
const setIdKey = "forwardStepwiseRegression";

const ForwardStepwiseRegression: React.FunctionComponent = ({
  isOpen,
  close,
  OpenHelpWindow,
  helpMenu,
  ...
  useEffect(() => {
    help("wbasics", "options_for_forward_stepwise_regression__criterion", "");
    getOptionsData();
  }, []);
  const getSelectedItem = (
    ...
    if (item.props.headerText == "Criterion") {
      help("wbasics", "options_for_forward_stepwise_regression__criterion", "");
    } else if (item.props.headerText == "Assumption Checking") {
      help(
        "wbasics",
        "options_for_forward_stepwise_regression__assumption_checking",
        ""
      );
    } else if (item.props.headerText == "Residuals") {
      help("wbasics", "options_for_forward_stepwise_regression__residuals", "");
    } else if (item.props.headerText == "More Statistics") {
      help(
        "wbasics",
        "options_for_forward_stepwise_regression__more_statistics",
        ""
      );
    } else if (item.props.headerText == "Other Diagnostics") {
      help(
        "wbasics",
        "options_for_forward_stepwise_regression__other_diagnostics",
        ""
      );
    }
  };
            ...
            <Pivot
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_forward_stepwise_regression__criterion",
                    ""
                  )
                }>
                <div className={contentStyles.columns}>
                  <label style={{ flex: "0 0 30%" }}>F-to-Enter</label>
                  <TextField
                    name='StrFtoEnter'
                    value={options.CCriterionFtoEnter[0].inputData}
                    onChange={(e) =>
                      udpateOptions(
                        "CCriterionFtoEnter",
                        e,
                        0,
                        options.CCriterionFtoEnter[0]
                      )
                    }
                  />
                </div>
                <div className={contentStyles.columns}>
                  <label style={{ flex: "0 0 30%" }}>F-to-Remove</label>
                  <TextField
                    name='StrFtoRemove'
                    value={options.CCriterionFtoEnter[1].inputData}
                    onChange={(e) =>
                      udpateOptions(
                        "CCriterionFtoEnter",
                        e,
                        1,
                        options.CCriterionFtoEnter[1]
                      )
                    }
                  />
                </div>
                <div className={contentStyles.columns}>
                  <label style={{ flex: "0 0 30%" }}>Number of Steps</label>
                  <TextField
                    name='StrNumberOfSteps'
                    value={options.CCriterionFtoEnter[2].inputData}
                    onChange={(e) =>
                      udpateOptions(
                        "CCriterionFtoEnter",
                        e,
                        2,
                        options.CCriterionFtoEnter[2]
                      )
                    }
                  />
                </div>
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_forward_stepwise_regression__residuals",
                    ""
                  )
                }>
                <br />
                ...
                <div className={contentStyles.residualSection}>
                  <div>
                    <fieldset
                      ...
                      <div style={{ marginLeft: "28px", display: 'flex' }}>
                        <label style={{ marginRight: '10px' }}>Starting in Column</label>
                        <Dropdown
                          disabled={
                            !(
...
export default ForwardStepwiseRegression;
