...
const tabKeys: string[] = ["CAssumeCheck", "CResultsPercentile", "COtherTest"];
const setIdKey = "anovaOnRanks";

const ANOVAOnRanks: React.FunctionComponent = ({
  isOpen,
  close,
  OpenHelpWindow,
  helpMenu,
  ...
  useEffect(() => {
    help("wbasics", "options_for_anova_on_ranks__assumption", "");
    getOptionsData();
  }, []);
  const getSelectedItem = (
    ...
    if (item.props.headerText == "Assumption Checking") {
      ...
      help("wbasics", "options_for_anova_on_ranks__results", "");
    } else if (item.props.headerText == "Post Hoc Tests") {
      help("wbasics", "options_for_anova_on_ranks__post_hoc_tests", "");
    }
  };
  return (
    <div>
            ...
            <Pivot
              ...
              <PivotItem
                ...
                <fieldset className={contentStyles.fieldSet}>
                  ...
                  <Checkbox
                    label='Summary Table'
                    checked={options.CResultsPercentile[0].checked}
                    onChange={(e) => udpateOptions("CResultsPercentile", e, 0)}
                  />
                  <div className={contentStyles.columns}>
                    ...
                    <div style={{ flex: "0 0 20%" }}>
                      <TextField
                        name='StrFromPercent'
                        value={options.CResultsPercentile[1].inputData}
                        onChange={(e) =>
                          udpateOptions(
                            "CResultsPercentile",
                            e,
                            1,
                            options.CResultsPercentile[1]
                          )
                        }
                      />
                    </div>
                    ...
                    <div style={{ flex: "0 0 20%" }}>
                      <TextField
                        // suffix='th Percentiles'
                        name='StrToPercent'
                        value={options.CResultsPercentile[2].inputData}
                        onChange={(e) =>
                          udpateOptions(
                            "CResultsPercentile",
                            e,
                            2,
                            options.CResultsPercentile[2]
                          )
                        }
                      />
                    </div>
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_anova_on_ranks__post_hoc_tests",
                    ""
                  )
                }
                className={contentStyles.pocSection}>
                ...
                <fieldset className={contentStyles.fieldSet}>
                  ...
                  <ChoiceGroup
                    defaultSelectedKey={options.COtherTest[0].radioData}
                    options={[
                  ...
                  <label style={{ marginTop: "10px", display: "inline-block" }}>
                    The significance level for P values is found on the Report tab of the Options dialog that is accessed from the main button
                  </label>
                </fieldset>
              </PivotItem>
            </Pivot>
