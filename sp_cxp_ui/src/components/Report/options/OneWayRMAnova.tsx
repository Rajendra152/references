...
const setIdKey = "oneWayRMAnova";

const OneWayRMANOVA: React.FunctionComponent = ({
  isOpen,
  close,
  OpenHelpWindow,
  helpMenu,
  ...
  useEffect(() => {
    help(
      "wbasics",
      "options_for_one_way_repeated_measures_anova__assumption_checking",
      ""
    );
    getOptionsData();
  }, []);
  const getSelectedItem = (
    ...
    if (item.props.headerText == "Assumption Checking") {
      ...
      help("wbasics", "options_for_one_way_rm_anova__results", "");
    } else if (item.props.headerText == "Post Hoc Tests") {
      help("wbasics", "options_for_one_way_rm_anova__post_hoc_tests", "");
    }
  };
  return (
    <div>
            ...
            <Pivot
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_one_way_rm_anova__post_hoc_tests",
                    ""
                  )
                }
                className={contentStyles.pocSection}>
