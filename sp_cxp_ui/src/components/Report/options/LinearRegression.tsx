...
const setIdKey = "linearRegression";
const helpIcon: IIconProps = { iconName: "Help" };
const dropdownStyles: Partial<IDropdownStyles> = {
  dropdown: { width: 110 },
};

const LinearRegression: React.FunctionComponent = ({
  isOpen,
  close,
  OpenHelpWindow,
  helpMenu,
  ...
  useEffect(() => {
    help("wbasics", "options_for_linear_regression__assumption_checking", "");
    getOptionsData();
  }, []);
  const getSelectedItem = (
    ...
    if (item.props.headerText == "Assumption Checking") {
      ...
      help("wbasics", "options_for_linear_regression__more_statistics", "");
    } else if (item.props.headerText == "Residuals") {
      help("wbasics", "options_for_linear_regression__residuals", "");
    } else if (item.props.headerText == "Other Diagnostics") {
      help("wbasics", "options_for_linear_regression__other_diagnostics", "");
    }
  };
  return (
    <div>
            ...
            <Pivot
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_linear_regression__assumption_checking",
                    ""
                  )
                }
                style={{ display: "flex" }}>
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_linear_regression__residuals",
                    ""
                  )
                }>
                <br />
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_linear_regression__more_statistics",
                    ""
                  )
                }>
                <br />
              ...
              <PivotItem
                ...
                onClick={() =>
                  help(
                    "wbasics",
                    "options_for_linear_regression__other_diagnostics",
                    ""
                  )
                }
