...
const MultipleControlL3: React.FunctionComponent = (props) => {
  ...
  const [selectedItem, setSelectedItem] = React.useState<IDropdownOption>();
    ...
    const [levelOne, setLevelOne] = useState("Col10");
    const [levelTwo, setLevelTwo] = useState("Col11");
    const [levelThree, setLevelThree] = useState("Col12");
              ...
              <div className="ms-Grid-col ms-sm4 ms-xl4">
                <Stack styles={stackStyles} tokens={verticalGapStackTokens}>
                  ...
                  <TextField
                    ...
                    multiline
                    readOnly
                    defaultValue="0.23 0.22 0.04"
                  />
                </Stack>
              </div>
              <div className="ms-Grid-col ms-sm4 ms-xl4">
                <Stack styles={stackStyles} tokens={verticalGapStackTokens}>
                  <Label>Levels for: {levelThree}</Label>
                  <TextField
                    inputClassName={multipleComparisonStyle.textField}
                    multiline
                    readOnly
...
export default connect(mapStateToProps, mapDispatchToProps)(MultipleControlL3);
