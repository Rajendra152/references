...
import { closeWindow } from "../DataTransfer/DataTransfer";
import {BWLogo}  from "../../../Constant/ConstantImage";
  ...
  render() {
    ...
    return (
      <>
        ...
        <img style={{marginTop:"2px",width:"16px",height:"16px"}} src={BWLogo}></img> <span  className={`wizard-title ${alignIcons}`} style={{padding:"6px",fontSize:"14px",marginTop:"1px",marginRight:"360px"}}>{this.props.title + this.state.subtitle}</span>
