  ...
  return (
    <div>
      <Modal
        ...
        // onDismiss={}
        isDarkOverlay={false}
        className={(windowSize=='small')? '': 'bigwindow'}
        isModeless={isModeless}
        isBlocking={isBlocking}
        containerClassName={(className ? className + ' ' : '') + contentStyles.container + ' childModal modalSection'}
...
export default connect(mapStateToProps)(ModalCompontent)
