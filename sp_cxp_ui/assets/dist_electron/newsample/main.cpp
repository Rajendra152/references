...
void ShowLicEngineSample()
{
	...
	*npLicManagerType = 1;
	...
	int nApplyLicType = 0;  //  0 - For V2C; 1 - For Product Key
	char * sLicSrc = (char*)malloc(512 * sizeof(char));
	char * sLicStatusInfo = (char*)malloc(512 * sizeof(char));
	sLicSrc = "D:\\LicenseEngine\\LicFile\\SP15_SA_MI_31Dec2022.v2c";  // Physical V2C file path location on running machine
